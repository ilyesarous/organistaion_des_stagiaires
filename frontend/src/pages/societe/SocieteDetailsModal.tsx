    ...
    <Modal show={show} onHide={onHide} centered size="lg">
      ...
      <Modal.Body>
        ...
        <Row>
          <Col md={6}>
            <p>
              <strong>ID:</strong> {societe.id}
            </p>
            <p>
              <strong>Matricule Fiscale:</strong> {societe.matricule_fiscale}
            </p>
            <p>
              <strong>UUID:</strong> {societe.uuid}
            </p>
            <p>
              <strong>Raison Sociale:</strong> {societe.raison_sociale}
            </p>
            <p>
              <strong>Email:</strong> {societe.email}
            </p>
            <p>
              <strong>Téléphone:</strong> {societe.phone || <em>N/A</em>}
            </p>
          </Col>

          <Col md={6}>
            <p>
              <strong>Site Web:</strong> {societe.site_web || <em>N/A</em>}
            </p>
            <p>
              <strong>Adresse:</strong> {societe.address || <em>N/A</em>}
            </p>
            <p>
              <strong>Créé le:</strong>{" "}
              {new Date(societe.created_at).toLocaleString()}
            </p>
            <p>
              <strong>Modifié le:</strong>{" "}
              {new Date(societe.updated_at).toLocaleString()}
            </p>
          </Col>
        </Row>
        <Row className="mb-3 text-center">
